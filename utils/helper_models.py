...
def split_dataset(df):
    ...
    df_train, df_test = train_test_split(df, test_size=0.2, random_state=42, stratify=df['Exited'], shuffle=True)
...
def read_features_name():
    ...
    categorical_features = ['MONTH', 'UNIQUE_CARRIER', 'ORIGIN', 'WEEK',  'ARRIVAL_TIME']
    numeric_features = ['DISTANCE', 'TAXI_OUT', 'TAXI_IN']
